...
const partIIIQuestions: readonly ShortAnswerQuestion[] = [
  ...
  },
  {
    ...
    label: "Câu 20.",
    type: "short_answer",
    stem: "Trong không gian Oxyz, cho mặt phẳng (P): 2x – y + 2z – 6 = 0. Tính khoảng cách từ điểm M(1; 3; –1) đến mặt phẳng (P).",
    difficulty: EDifficultyLevel.VAN_DUNG,
    domain: EKnowledgeDomain.HINH_HOC_KHONG_GIAN,
    isApplied: false,
    acceptedAnswers: ["3"],
    solutionSteps: [
      ...
      "Với a=2, b=–1, c=2, d=–6 và M(1; 3; –1):",
      "Tử số: |2·1 + (–1)·3 + 2·(–1) – 6| = |2 – 3 – 2 – 6| = |–9| = 9.",
      "Mẫu số: √(2²+(–1)²+2²) = √(4+1+4) = √9 = 3.",
      "d = 9/3 = 3.",
    ],
    conclusion: "Khoảng cách từ M đến mặt phẳng (P) là 3.",
  },
  {
    id: "P3_Q21",
    questionNumber: 21,
